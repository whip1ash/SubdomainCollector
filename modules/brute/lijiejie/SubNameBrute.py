...
if __name__ == '__main__':
    ...
    # use debug.txt smail sub dic
    parser.add_option('--debug',dest='debug',default=False, action='store_true')
    # use slient mode , don't out subdomains result
    #parser.add_option('--slient',dest='slient',default=False,action='store_true')
    ...
    # api_options['file'] = 'subnames.txt'
    # api_options['full_scan'] = False
    # api_options['i'] =
    ...
    d = SubNameBrute(target=args[0], options=api_options)
    d.run()
    d.outfile.flush()
    d.outfile.close()

    print (d.found_subs,d.ip_dict)
